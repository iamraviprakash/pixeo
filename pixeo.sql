...
CREATE TABLE `comments` (
  ...
  CONSTRAINT `fk_commentsUserId` FOREIGN KEY (`user_id`) REFERENCES `GUser` (`user_id`),
  CONSTRAINT `fk_commentsVideoId` FOREIGN KEY (`video_id`) REFERENCES `videos` (`video_id`)
...
CREATE TABLE `disliked_videos` (
  ...
  CONSTRAINT `fk_dislikedVideosUserId` FOREIGN KEY (`user_id`) REFERENCES `GUser` (`user_id`),
  CONSTRAINT `fk_dislikedVideosVideoId` FOREIGN KEY (`video_id`) REFERENCES `videos` (`video_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `history` (
  ...
  CONSTRAINT `fk_historyUserId` FOREIGN KEY (`user_id`) REFERENCES `GUser` (`user_id`),
  CONSTRAINT `fk_historyVideoId` FOREIGN KEY (`video_id`) REFERENCES `videos` (`video_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `liked_videos` (
  ...
  CONSTRAINT `fk_likedVideosUserId` FOREIGN KEY (`user_id`) REFERENCES `GUser` (`user_id`),
  CONSTRAINT `fk_likedVideosVideoId` FOREIGN KEY (`video_id`) REFERENCES `videos` (`video_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `videos` (
  ...
  CONSTRAINT `fk_videosUserId` FOREIGN KEY (`user_id`) REFERENCES `GUser` (`user_id`)
...
-- Dump completed on 2017-05-18  9:54:37

	...
	<div class="container-fluid">
		...
		<div class="row" id="main">
			...
			<div class="col-xs-7" id="main-body">
				...
				{
					$value=$_GET['category'];
					$sql="select category_name from categories where category_id='".$value."';";
					$result = $conn->query($sql);
					$row = $result->fetch_assoc();
					echo "<div id='title'>".$row['category_name']."</div>";
					//echo "<img src='Thumbnails/ai.jpg' id='titleImage'>";
					...
					join GUser c on b.user_id=c.user_id where b.category_id='".$value."' and b.status in ('A','N');";
				}

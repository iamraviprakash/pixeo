...
function Deny(vid,var_this,uname)
{
	...
	if(stat=='Deny')
	{
		...
		xhttp.onreadystatechange = function() {
	  	...
	  	var varurl="userdata.php?value=deny&v_id="+vid+"&u_name="+uname;
		...
		<div class="row" id="main">
			...
			<div class="col-xs-9" id="main-body">
				<div id="main-body-linkpanel">
					<a href="admin.php">Manage</a>&nbsp;&nbsp;<a href="newUploads.php">New Uploads</a>&nbsp;&nbsp;<a href="allowed.php"><u>Allowed</u></a>&nbsp;&nbsp;<a href="denied.php">Denied</a>
				</div>
				...
				$sql = "select b.remarks remarks,b.views views,c.user_username user_username,b.upload_time upload_time,
					...
					join GUser c on c.user_id=b.user_id where b.status='A' order by b.upload_time desc;";
					...
					{	echo "<hr>";
						echo "<table cellpadding='20'>";
					   	while($row=$result->fetch_assoc()) 
					   	{
							...
							echo '<button class="delete-button" onclick="Deny('.$video_id.',this,'.$uname.')">Deny</button>';
							echo '&nbsp;'.$row['remarks'];
							echo '</td>';
					   		echo "</tr>";
						}

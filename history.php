		...
		<div class="row" id="main">
			<div class="col-xs-2" id="sidepane">
				<ul type="none">
					...
					<li><a href="history.php"><button class="sidepane-button" id="history"><span class="glyphicon glyphicon-hourglass"></span> History</button></a></li>
					<hr>
			...
			<div class="col-xs-7" id="main-body">
				...
				$sql = "select b.views views,c.user_username user_username,b.videothumbnail_path videothumbnail_path,
					...
					join GUser c on c.user_id=b.user_id where a.user_id=$uid and b.status in ('N', 'A') order by a.watch_time desc;";
